...
export class CommentService {
  ...
  addComment(comment: any): Observable<any> {
    return this.httpClient.post(`${environment.serverURL}` + apiUrlComment +
        '/addComment', comment, { ...httpOptions, responseType: 'text'}).pipe(
        tap(),
 ...
 updateComment(comment: any): Observable<any> {
  ...
  getCommentsByResource(idRessource): Observable<any> {
    ...
    return this.httpClient.get(`${environment.serverURL}` + apiUrlComment +
        '/getCommentsByResource', { ...httpOptions, responseType: 'json', params }).pipe(
  ...
  deleteComment(idComment: any): Observable<any> {
    ...
    return this.httpClient.delete(`${environment.serverURL}` + apiUrlComment +
        '/delComment', { ...httpOptions, responseType: 'text', params} ).pipe(
