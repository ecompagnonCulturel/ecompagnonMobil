...
export class NoteService {
  ...
  getNoteByUserAndResource(idUser, idResource): Observable<any> {
    ...
    return this.httpClient.get(`${environment.serverURL}` + apiNote+"/getNoteByUserAndResource", { ...httpOptions, responseType: 'json',params:params})
        .pipe(
            tap(),
  ...
  deleteNote(id: any): Observable<any>{
    ...
    return  this.httpClient.delete(`${environment.serverURL}` + apiNote+"/delNote",{ ...httpOptions, responseType: 'text',params:params}).pipe(
        tap(),
