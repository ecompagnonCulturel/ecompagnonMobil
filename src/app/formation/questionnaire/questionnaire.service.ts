...
export class QuestionnaireService {
    ...
    getByGroupeEtudiantBySessionAndEtudiantList(session: any, CP: any): Observable<any> {
        const params = {
            session,
            cp: CP
        };
        return this.httpClient.get(`${environment.serverURL}` + apiUrlEtudGroup + '/getBySessionAndEtudiantList', {
            ...httpOptions,
            responseType: 'json',
            params
        }).pipe(
